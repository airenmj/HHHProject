...
public class ReportCommand implements VCommand {
	...
	private void emailSendAction(String hNo, String hName, String memberNickname, String reportTitle, String reportContent, String reportEmail) {
		...
		String content=hName+"님의 "+hNo+"번 글에 대한 신고 사항입니다"
				+"<br>신고자 닉네임 : "+memberNickname+"<br>신고자 이메일 : "+reportEmail+"<br>신고 제목 : "+reportTitle+"<br>신고 내용 : "+reportContent;
